...
/*
 ...
 Napisati klasu Osoba. Klasa treba da sadrži polja: ime (DinString) i prezime (DinString). 
 ...
 Napisati klasu Student koja nasleđuje klasu Osoba. Klasa treba da sadrži i dodatno polje: brojIndeksa (int). 
 Za klasu je potrebno implementirati:
     Student();
 ...
 Klasa Student redefiniše metodu predstaviSe() tako što dopisuje i broj indeksa.
 Napisati klasu PhDStudent koja nasleđuje klasu Student. Klasa treba da sadrži i dodatno polje: prosecnaOcena (double). 
 Za klasu je potrebno implementirati:
     PhDStudent();
 ...
 Klasa PhDStudent redefiniše metodu predstaviSe() tako što dopisuje i prosečnu ocenu. 
