...
/*
 ...
 Uz upotrebu kompozicije napisati klasu Auto koja modeluje Automobil sa klasama Menjac i Skoljka. Klasa Menjac treba da ima dva polja koja predstavljaju broj brzina menjača i tip menjača (automatik ili manuelni). Klasa Skoljka treba da ima jedno polje koje predstavlja boju školjke.
 ...
 IMPLEMENTIRATI
     ...
     - za klasu MENJAC:
         ...
         5. metodu string getTip() const - za klasu SKOLJKA:
         1. prazan konstruktor, konstruktor sa parametrima i kopije 
 ...
 NAPOMENE:
     - Tip menjača (1. automatik 2.manuelni) – enum
